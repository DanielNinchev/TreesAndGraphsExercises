...
namespace GraphUsingAdjacencyMatrix
{
    ...
    public class Graph
    {
        ...
        public Graph(List<int>[] childNodes) => this.childNodes = childNodes;
        ...
        public void AddEdge(int u, int v) => this.childNodes[u].Add(v);

        /// <summary> Removes the edge from u to v if such exists </summary>
        /// <param name="u">the starting vertex</param>
        /// <param name="v">the ending vertex</param>

        public bool HasEdge(int u, int v) => this.childNodes[u].Contains(v);
